...
public class UserServiceImpl implements UserService {
	...
	public Users saveUser(Users user) {
		...
		qrCodeUtils.createQRCode(qrCodePath, "sweet_chat_qrcode:" + user.getUsername());
...
//		}
	...
	public Integer preconditionSearchFriends(String myUserId, String friendUsername) {
		...
		Users freindUser = queryUserInfoByUsername(friendUsername);
		...
		if (freindUser.getId().equals(myUserId)) {
		...
		mfc.andEqualTo("myFriendUserId", freindUser.getId());
